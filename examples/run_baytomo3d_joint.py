...
output_location = "./modelsearch_joint"
...
input_files = ["dataset_surfacewaves/dataset_small_test.dat"] 
...
# for body waves)
likelihood_distribution = 'outliers' #['students_t','outliers','normal']*10
...
# any model updates.
crustal_model_file = None #  'path/to/file.txt' or None
